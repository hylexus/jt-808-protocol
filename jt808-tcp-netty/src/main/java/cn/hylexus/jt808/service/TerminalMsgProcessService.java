...
import cn.hylexus.jt808.processor.impl.StandardGPSUploadProcessor;
...
public class TerminalMsgProcessService extends BaseMsgProcessService {
  ...
  /**
   * Terminal device location upload request processor
   *
   * @param req
   * @throws Exception
   */
  public void processLocationUploadMsg(PackageData req, String deviceId) throws Exception {
    StandardGPSUploadProcessor p = new StandardGPSUploadProcessor(deviceId);
    p.process(req);
  }
}
